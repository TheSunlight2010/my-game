...
function classifyCharacterByHealing(char, keyName = '') {
    ...
    const varyKeys = ['seven', 'reflection', 'wachi', 'eteleD', 'fyre', 'judgement'];
...
function renderCharactersList() {
    ...
    entries.forEach(entry => {
        ...
        // Determine classification label for this character (pass key so special no-sub entries remain plain)
        const classLabel = classifyCharacterByHealing(entry.data || {}, entry.key);
